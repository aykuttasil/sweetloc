...
object Versions {
    ...
    const val play_services_gcm: String = "16.1.0"

    const val play_services_location: String = "16.0.0"

    const val play_services_maps: String = "16.1.0"
    ...
    const val firebase_config: String = "16.5.0"
    ...
    const val firebase_dynamic_links: String = "16.1.8"

    const val firebase_messaging: String = "17.6.0"
    ...
    const val onesignal_gradle_plugin: String = "0.12.1"
