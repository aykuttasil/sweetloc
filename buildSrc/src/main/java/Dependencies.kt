...
object Libs {
    val androidGradlePlugin = "com.android.tools.build:gradle:3.5.0-alpha08"
    ...
    object Kotlin {
        val stdlib = "org.jetbrains.kotlin:kotlin-stdlib-jdk8:${Versions.kotlin_version}"
        val reflect = "org.jetbrains.kotlin:kotlin-reflect:${Versions.kotlin_version}"
        val gradlePlugin = "org.jetbrains.kotlin:kotlin-gradle-plugin:${Versions.kotlin_version}"
        val extensions = "org.jetbrains.kotlin:kotlin-android-extensions:${Versions.kotlin_version}"
    }
